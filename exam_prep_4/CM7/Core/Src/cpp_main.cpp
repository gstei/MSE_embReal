 ...
 */
#define LED_example //LED_example, LED_finite_state_machine
#include "main.h"
#include "cpp_main.h"
#include <iostream>
#include <string>
...
#include "AccGyroSensor.h" // Acceleromator and Gyroscope sensor
...
AccGyroSensor AccGyroSensor1;
AccGyroSensor1.initSensor();
int32_t AccXAxis;
int32_t AccYAxis;
int32_t AccZAxis;
while (1)
